...
##        cv2.waitKey(0)
        ...
        cv2.drawContours(colMask, contour, -1, (0,0,255), -1)
        cv2.drawContours(colMask, contour, -1, (0,0,0), 3)

        textMask = cv2.bitwise_and(frame,mask)
        textMask = cv2.bitwise_not(textMask)
        textMask = cv2.bitwise_and(colMask,textMask)
        ...
        #frame = cv2.add(original,colMask)
        frame = cv2.bitwise_or(original,colMask)
